...
หน้าที่ของคุณคือรับ "ข้อความสรุปสภาวะตลาด" และตัดสินใจทันทีว่าจะ BUY, SELL หรือ WAIT
ตอบเป็นภาษาไทย สั้น กระชับ ใช้ HTML format (<b>, <i>, <pre>) ห้ามใช้ Markdown ** เด็ดขาด`;

        // 4. ประกอบ Prompt ขั้นเทพ (แบบเล่าเรื่อง - สั้น ประหยัด Token สุดๆ)
        ...
        const prompt = `
            ...
            ห้ามเขียนอธิบายน้ำท่วมทุ่ง เด็ดขาด!
        `;
