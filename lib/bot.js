...
ตอบกลับเฉพาะรูปแบบ JSON ที่กำหนด ห้ามมีข้อความอื่นนอกกรอบ JSON เด็ดขาด (ยกเว้นแท็ก <think>)`;
        ...
        const guides = [
            `[Cluster 1: Momentum (MACD+RSI)] ขัดแย้งกับกราฟราคา (Divergence) หรือไม่? โมเมนตัมซัพพอร์ตเทรนด์หรือกำลังแผ่วลง?`,
            `[Cluster 2: Structure & Action] ราคาเบรคหลอกหรือไม่? แพทเทิร์นแท่งเทียนเกิดที่จุดสำคัญและสอดคล้องกับโครงสร้าง 24H หรือไม่?`,
        ...
        const prompt = `
            ...
            คำสั่งเพิ่มเติมเรื่อง Spread & Slippage:
            - ในการตั้งจุดบังหน้าทุน (be) ให้เผื่อระยะ Spread และ Slippage เสมอ (อย่างน้อย 0.5 ดอลลาร์ หรือ 50 pips จากจุด entry) ห้ามตั้ง be = entry เป๊ะๆ
            - พิจารณา R:R โดยหักลบ 0.5 ดอลลาร์เป็นต้นทุนเสมอ
