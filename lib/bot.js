...
ตอบเป็นภาษาไทย ใช้ HTML format (<b>, <i>, <pre>) ห้ามใช้ Markdown ** เด็ดขาด`;
        ...
        if (hasMACD || triggerReasons.length === 0) guides.push(
            `[MACD Momentum] ทิศทางราคาขัดแย้งกับ MACD หรือไม่ (Divergence)? ถ้าโมเมนตัมสวนทางกับกราฟให้ระวังการดึงกลับกิน SL (พิจารณา WAIT)`
        );
        ...
        const prompt = `
            ...
            <think>
            คำสั่งบังคับ: ห้ามอธิบายยาวเกิน 3 บรรทัดเด็ดขาด ให้สรุปใจความสำคัญสั้นๆ
            วิเคราะห์ตามกรอบนี้: ${guides.join(' | ')}
            สรุป: สอดคล้องกันกี่ข้อ? (≥ 2 ข้อ = ให้สัญญาณ, ขัดแย้ง = WAIT)
            </think>
