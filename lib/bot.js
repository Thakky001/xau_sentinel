...
// ============================================================
// State Tracking สำหรับ Dashboard
// ============================================================
const COOLDOWN_MS = 1 * 60 * 60 * 1000; // 1 ชั่วโมง
const INTERVAL_MS = 15 * 60 * 1000;     // 15 นาที

let lastAlertTime = 0;

// State object ที่ Dashboard จะดึงไปแสดง
const botState = {
...
export async function runScoutBot(testMode = false) {
    ...
    botState.nextRunAt = calcNextM15() + INTERVAL_MS;
