...
function processCandles(candles, mode = 'full') {
    ...
    let closedCandles = candles.slice(0, -1);

    // 👁️ H1 Time Lag Fix: 
    // สำหรับ H1 (โหมด light) เราอนุญาตให้นับ Live Candle เป็นส่วนหนึ่งของการคำนวณเทรนด์ได้
    // เพื่อให้ EMA/ADX ภาพใหญ่สะท้อนราคา 45 นาทีล่าสุด (ภาพใหญ่เปลี่ยน) 
    // ส่วนจุดเข้าเทรดจริงจะยังคงโดนคุมด้วย M15 Closed Candle อยู่ดี ทำให้ไม่มี Look-ahead Bias ในจุดเข้า
    if (mode === 'light') {
