...
function processCandles(candles, mode = 'full') {
    ...
    return {
        ...
        breakout:           checkBreakout(parseFloat(currentLiveCandle.close), recent_high, recent_low),
...
export function calcFibonacci(recentHigh, recentLow, marketStructure = "ขาขึ้น") {
    ...
    // ถ้าเป็นขาลง ให้ลาก Fibo จากบนลงล่าง (38.2% อยู่ด้านบน)
    ...
    // ค่าเริ่มต้น (ขาขึ้น หรือ Sideway) ลากจากล่างขึ้นบน
    return {
