...
function processCandles(candles, mode = 'full') {
    // 1. แยกแท่งที่ยังไม่ปิดทิ้งเพื่อป้องกัน Look-ahead Bias (ใช้แท่งสุดท้ายแค่เก็บราคาสด)
    // แก้ไข: บังคับตัดแท่งสุดท้าย (Live) ออกเสมอ ไม่ว่าจะเป็นโหมดใด เพื่อป้องกัน Repainting
